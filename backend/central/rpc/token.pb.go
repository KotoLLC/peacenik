...
func (x *TokenPostMessageRequest) GetNodes() []string {
	if x != nil {
		return x.Nodes
	}
	return nil
...
func (x *TokenPostMessageResponse) GetTokens() []string {
	if x != nil {
		return x.Tokens
	}
	return nil
...
type TokenGetMessagesRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TokenGetMessagesRequest) Reset() {
	*x = TokenGetMessagesRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *TokenGetMessagesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TokenGetMessagesRequest) ProtoMessage() {}

func (x *TokenGetMessagesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_token_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TokenGetMessagesRequest.ProtoReflect.Descriptor instead.
func (*TokenGetMessagesRequest) Descriptor() ([]byte, []int) {
	return file_token_proto_rawDescGZIP(), []int{3}
}

func (x *TokenGetMessagesRequest) GetNodes() []string {
	if x != nil {
		return x.Nodes
	}
	return nil
...
func (x *TokenGetMessagesResponse) GetTokens() []string {
	if x != nil {
		return x.Tokens
	}
	return nil
...
var file_token_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x2f, 0x0a, 0x17, 0x54, 0x6f,
	...
	0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x6e, 0x6f, 0x64, 0x65, 0x73, 0x22, 0x32, 0x0a, 0x18, 0x54,
	...
	0x2f, 0x0a, 0x17, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x47, 0x65, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x6e, 0x6f,
	0x64, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x6e, 0x6f, 0x64, 0x65, 0x73,
	0x22, 0x32, 0x0a, 0x18, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x47, 0x65, 0x74, 0x4d, 0x65, 0x73, 0x73,
	...
	0x6b, 0x65, 0x6e, 0x73, 0x32, 0xd2, 0x01, 0x0a, 0x0c, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x53, 0x65,
	...
	0x0b, 0x47, 0x65, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x12, 0x1c, 0x2e, 0x72,
	0x70, 0x63, 0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x47, 0x65, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x72, 0x70, 0x63,
	0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x47, 0x65, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
...
var file_token_proto_goTypes = []interface{}{
	...
	(*TokenGetMessagesRequest)(nil),  // 3: rpc.TokenGetMessagesRequest
	(*TokenGetMessagesResponse)(nil), // 4: rpc.TokenGetMessagesResponse
	(*Empty)(nil),                    // 5: rpc.Empty
}
var file_token_proto_depIdxs = []int32{
	5, // 0: rpc.TokenService.Auth:input_type -> rpc.Empty
	1, // 1: rpc.TokenService.PostMessage:input_type -> rpc.TokenPostMessageRequest
	3, // 2: rpc.TokenService.GetMessages:input_type -> rpc.TokenGetMessagesRequest
	0, // 3: rpc.TokenService.Auth:output_type -> rpc.TokenAuthResponse
	2, // 4: rpc.TokenService.PostMessage:output_type -> rpc.TokenPostMessageResponse
	4, // 5: rpc.TokenService.GetMessages:output_type -> rpc.TokenGetMessagesResponse
...
func file_token_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_token_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TokenGetMessagesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
