...
type TokenService interface {
	...
	GetMessages(context.Context, *TokenGetMessagesRequest) (*TokenGetMessagesResponse, error)
}
...
func (c *tokenServiceProtobufClient) GetMessages(ctx context.Context, in *TokenGetMessagesRequest) (*TokenGetMessagesResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "rpc")
	ctx = ctxsetters.WithServiceName(ctx, "TokenService")
...
func (c *tokenServiceJSONClient) GetMessages(ctx context.Context, in *TokenGetMessagesRequest) (*TokenGetMessagesResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "rpc")
	ctx = ctxsetters.WithServiceName(ctx, "TokenService")
	ctx = ctxsetters.WithMethodName(ctx, "GetMessages")
	out := new(TokenGetMessagesResponse)
...
func (s *tokenServiceServer) serveGetMessagesJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	reqContent := new(TokenGetMessagesRequest)
	unmarshaler := jsonpb.Unmarshaler{AllowUnknownFields: true}
	if err = unmarshaler.Unmarshal(req.Body, reqContent); err != nil {
		s.writeError(ctx, resp, malformedRequestError("the json request could not be decoded"))
		return
...
var twirpFileDescriptor2 = []byte{
	...
	,
}
