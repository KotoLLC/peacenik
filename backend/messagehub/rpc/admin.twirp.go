...
func NewAdminServiceProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) AdminService {
	...
	serviceURL += baseServicePath(clientOpts.PathPrefix(), "rpc", "AdminService")
	urls := [1]string{
		serviceURL + "DestroyData",
	}
...
func (c *adminServiceProtobufClient) DestroyData(ctx context.Context, in *Empty) (*Empty, error) {
	ctx = ctxsetters.WithPackageName(ctx, "rpc")
	ctx = ctxsetters.WithServiceName(ctx, "AdminService")
	ctx = ctxsetters.WithMethodName(ctx, "DestroyData")
	caller := c.callDestroyData
		...
		caller = func(ctx context.Context, req *Empty) (*Empty, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return c.callDestroyData(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
...
func (c *adminServiceProtobufClient) callDestroyData(ctx context.Context, in *Empty) (*Empty, error) {
	out := new(Empty)
...
func (c *adminServiceJSONClient) DestroyData(ctx context.Context, in *Empty) (*Empty, error) {
	ctx = ctxsetters.WithPackageName(ctx, "rpc")
	ctx = ctxsetters.WithServiceName(ctx, "AdminService")
	ctx = ctxsetters.WithMethodName(ctx, "DestroyData")
	caller := c.callDestroyData
...
func (c *adminServiceJSONClient) callDestroyData(ctx context.Context, in *Empty) (*Empty, error) {
	out := new(Empty)
...
func NewAdminServiceServer(svc AdminService, opts ...interface{}) TwirpServer {
	...
	for _, opt := range opts {
		...
		case nil: // backwards compatibility, allow nil value for the argument
			continue
		default:
			panic(fmt.Sprintf("Invalid option type %T on NewAdminServiceServer", o))
		}
	}
...
// AdminServicePathPrefix is a convenience constant that could used to identify URL paths.
...
func (s *adminServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "rpc.AdminService" {
	...
	switch method {
	case "DestroyData":
		s.serveDestroyData(ctx, resp, req)
		return
	default:
		msg := fmt.Sprintf("no handler for path %q", req.URL.Path)
		s.writeError(ctx, resp, badRouteError(msg, req.Method, req.URL.Path))
...
func (s *adminServiceServer) serveDestroyData(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	case "application/json":
		s.serveDestroyDataJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveDestroyDataProtobuf(ctx, resp, req)
	default:
...
func (s *adminServiceServer) serveDestroyDataJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "DestroyData")
	...
	handler := s.AdminService.DestroyData
		...
		handler = func(ctx context.Context, req *Empty) (*Empty, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.AdminService.DestroyData(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*Empty)
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *Empty and nil error while calling DestroyData. nil responses are not supported"))
		return
	}
...
func (s *adminServiceServer) serveDestroyDataProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "DestroyData")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *adminServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "rpc", "AdminService")
}
...
var twirpFileDescriptor0 = []byte{
	...
	0xcc, 0xd3, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x2e, 0x2a, 0x48, 0x96, 0xe2, 0xce, 0xcd,
	0x4f, 0x49, 0xcd, 0x81, 0x88, 0x18, 0x99, 0x72, 0xf1, 0x38, 0x82, 0x14, 0x04, 0xa7, 0x16, 0x95,
	0x65, 0x26, 0xa7, 0x0a, 0xa9, 0x72, 0x71, 0xbb, 0xa4, 0x16, 0x97, 0x14, 0xe5, 0x57, 0xba, 0x24,
	0x96, 0x24, 0x0a, 0x71, 0xe9, 0x15, 0x15, 0x24, 0xeb, 0xb9, 0xe6, 0x16, 0x94, 0x54, 0x4a, 0x21,
	0xb1, 0x9d, 0x38, 0xa2, 0xd8, 0xf4, 0xf4, 0xf4, 0x8b, 0x0a, 0x92, 0x93, 0xd8, 0xc0, 0xe6, 0x18,
	0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xab, 0xd6, 0x21, 0xaf, 0x68, 0x00, 0x00, 0x00,
}
