...
export enum Types {
  GET_FEED_TOKENS_MESSAGES_REPORTS_REQUEST = 'GET_FEED_TOKENS_MESSAGES_REPORTS_REQUEST',
  
  GET_FEED_TOKENS_MESSAGES_REPORTS_FROM_HUB_REQUEST = 'GET_FEED_TOKENS_MESSAGES_REPORTS_FROM_HUB_REQUEST', 
  GET_FEED_TOKENS_MESSAGES_REPORTS_FROM_HUB_SUCCESS = 'GET_FEED_TOKENS_MESSAGES_REPORTS_FROM_HUB_SUCCESS', 
  
  RESOLVE_REPORT_REQUEST = 'RESOLVE_REPORT_REQUEST', 
  DELETE_REPORTED_FEED_MESSAGES_REQUEST = 'DELETE_REPORTED_FEED_MESSAGES_REQUEST', 
...
const getMessageReportsRequest = () => ({
  type: Types.GET_FEED_TOKENS_MESSAGES_REPORTS_REQUEST,
})

const getMessageReportsFronHubRequest = (payload: string) => ({
  type: Types.GET_FEED_TOKENS_MESSAGES_REPORTS_FROM_HUB_REQUEST,
  payload
})

const getMessageReportsFronHubSuccess = (payload: ApiTypes.Dashboard.ObjectionableContent[]) => ({
  type: Types.GET_FEED_TOKENS_MESSAGES_REPORTS_FROM_HUB_SUCCESS,
  payload
})
...
const deleteReportedMessageRequest = (payload: ApiTypes.Dashboard.DeleteReportedMessage) => ({
  type: Types.DELETE_REPORTED_FEED_MESSAGES_REQUEST,
  payload
})
