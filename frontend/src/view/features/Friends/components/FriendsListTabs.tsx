...
import { ListTabsWrapper, ListTabs, ListTab } from "./styles";
  ...
  return (
    <ListTabsWrapper>
      ...
      >
        ...
        />
        <ListTab
          label={`Invites (${invitations?.length})`}
          onClick={() => history.push("/friends/invitations")}
        />
      </ListTabs>
      <ButtonContained
...
const mapDispatchToProps = (dispatch): DispatchProps => ({
  onOpenInvitationsDialog: (value: boolean) =>
    dispatch(Actions.friends.openInvitationsDialog(value)),
});

export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(FriendsListTabs));
