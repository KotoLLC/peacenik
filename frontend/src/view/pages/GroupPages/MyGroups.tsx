        ...
        <GroupsListWrapper>
          {false ?
            ...
            <EmptyGroups>
              ...
              <EmptyGroupsTextWrapper>
                <EmptyGroupsText>
                  No groups. You can either <EmptyGroupsTextLink to="/groups/public">join a public group</EmptyGroupsTextLink> <br /> or <EmptyGroupsTextLink to="/groups/create">create</EmptyGroupsTextLink> a public or private group of your own
            </EmptyGroupsText>
              </EmptyGroupsTextWrapper>
            </EmptyGroups>
          }
