    ...
    <MessageSticky>
      <EditorBlockWrapper>
        <CreateWrapper>
          ...
          <EditorWrapper>
            <TextareaTitle className={value.length ? 'active' : ''}>
              Post a message to your friends
            </TextareaTitle>
            <EditMessageField>
              <MentionsInput
                className='mentions'
            ...
            {isHubsEmptyMessageShowed && (
              <ErrorMessage>
                You cannot post messages until you are friends with someone who
                has their own node. Alternatively, you can start a node
                yourself.
              </ErrorMessage>
            )}
          </EditorWrapper>
