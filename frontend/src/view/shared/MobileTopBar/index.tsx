  ...
  return (
    <MobileTopBarWrapper>
      ...
      <NavigationsWrapper>
        ...
        {isHamburgerMenuOpen && <ClickAwayListener onClickAway={() => { openHamburgerMenu(false) }}>
          <HamburgerMenu>
            <HamburgerMenuItem>
              <HamburgerMenuLink to="/messages">
                <HomeIcon className="icon" />
                Messages
              </HamburgerMenuLink>
            </HamburgerMenuItem>
            <HamburgerMenuItem>
              <HamburgerMenuLink to="/hubs">
            ...
            <HamburgerMenuItem>
              <HamburgerMenuLink to={`/profile/me`}> {/*`/profile/user?id=${userId}`*/}
